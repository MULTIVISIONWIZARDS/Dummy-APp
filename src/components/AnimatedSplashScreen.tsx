  ...
  return (
    <>
      ...
      >
        ...
        <View style={styles.content}>
          {/* Logo */}
           <Animated.View style={[styles.logoContainer, {transform: [{scale: logoScale}, {rotate: logoRotateInterpolation}, {scale: pulseAnim}]}]}>
          <View style={styles.logo}>
            <View style={styles.logoInner}>
              <Image
                style={{height: 115, width: 115, borderRadius: 50}}
