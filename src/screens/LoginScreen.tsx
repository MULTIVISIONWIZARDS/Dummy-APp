...
const AuthScreen = ({ navigation }) => {
  ...
  //   checkLogin();
  // }, []);
  // i want a backend for my react native app so give best what i use firebase,superbase,node.js mongodb,express js in comparison to time and minimum cost is priority in my app have login/signup then daily wellness category then subcategory and subscription and monthly one chat or weakly one chat per user depens on subscription but max weakly one chat and profile with update notification   
...
//         navigation.replace(AuthStackRoutes.Main);
//         // Or: navigation.replace('Subscription', { userId });
//       } else {
//         Toast.show({
//           type: 'error',
//           text1: result.payload || 'Signup failed',
