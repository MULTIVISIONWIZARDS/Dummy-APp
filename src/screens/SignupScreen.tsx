...
const SignupScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleSignup = (values: Record<string, string>) => {
    dispatch(signupUser({ name: values['Name'] ?? '', email: values['Email or Phone'] ?? '', password: values['Password'] ?? '' }));
  };
